                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Hostel Name</h4>
                                        ...
                                        <select class="custom-select mr-sm-2" id="hostel_id" name="hostel_id">
                                            <option selected>Choose...</option>
                                            <option value="101">Artemis</option>
                                            <option value="102">Orion</option>
                                            <option value="103">Valkyrie</option>
                                            <option value="104">Zeus</option>
                                            <option value="105">Messmer</option>
